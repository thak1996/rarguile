...
import 'package:rarguile/src/modules/detail_page/page/detail_page_guest.dart';
...
class DetailModuleGuest extends Module {
  @override
  ...
  List<ModularRoute> get routes => [
        ChildRoute(
          ...
          child: (context, args) => DetailPageGuest(
            videosGuest: args.data,
          ),
        )
      ];
}
