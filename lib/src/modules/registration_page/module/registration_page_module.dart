...
import 'package:rarguile/src/modules/registration_page/controller/register_datasource.dart';
...
class RegistrationPageModule extends Module {
  ...
  final List<Bind> binds = [
    Bind.lazySingleton((i) => RegistrationStore(registerDataSource: i())),
    Bind.lazySingleton((i) => RegisterDataSource(i())),
  ];
